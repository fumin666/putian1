<?php
	...
	//3）、传输数据（过桥）
	$sqlstr = "select * from goodsinfo where goodsName like '%$querystr%'";
	...
	while($query_row){
		$str = $str.'{ "goodsId":"'.$query_row[0].'","goodsName":"'.$query_row[1].'","address":"'.$query_row[2].'","goodsPrice":"'.$query_row[3].'","goodsWeight":"'.$query_row[4].'","goodsDesc":"'.$query_row[5].'","goodsImg":"'.$query_row[6].'","goodsCount":"'.$query_row[7].'"}';
